...
st.header("Welcome to Carbon Footprint Tracker")
st.markdown("<h4 style='text-align: center; color: white;'>(Built by Team Kodierer)</h4>", unsafe_allow_html=True)
...
if menu == 'Home':
    ...
    def load_image(img):
        ...
        return im
    st.image(load_image("assets/reduce-footprint-img.jpg"))
    ...
    def load_image(img):
        im = Image.open(os.path.join(img))
        return im
    st.image(load_image("assets/nitin-img.jpeg"))
    st.write("NITIN SINGH")
    st.write("DATA ANALYST")
    st.write("SRM UNIVERSITY")


    def load_image(img):
        im = Image.open(os.path.join(img))
        return im
    st.image(load_image("assets/karthik-img.jpeg"))
    st.write("KARTHIK KRAPA")
    ...
    def load_image(img):
        im = Image.open(os.path.join(img))
        return im
    st.image(load_image("assets/arun-img.jpeg"))
    st.write("ARUN KUMAR M")
    st.write("DATA SCIENTIST")
    st.write("SRM UNIVERSITY")
